...
var brokenModifierNames = chrome2 && (mac3 || +chrome2[1] < 57) || gecko2 && mac3;
for (i = 0; i < 10; i++)
...
var CommandManager = class {
  ...
  createCan(startTr) {
    ...
    const formattedCommands = Object.fromEntries(Object.entries(rawCommands).map(([name, command2]) => {
      return [name, (...args) => command2(...args)(__spreadProps(__spreadValues({}, props), { dispatch }))];
    }));
...
//# sourceMappingURL=chunk-K2MJ7BQ5.js.map
